...
def train_model(model, args, trainset_reader, validset_reader):
    ...
    #crit = nn.TripletMarginWithDistanceLoss(distance_function=lambda x, y: F.cosine_similarity(x, y))
    #crit = nn.TripletMarginWithDistanceLoss(distance_function=lambda x, y: torch.sub(1,torch.acos(torch.cosine_similarity(x, y)))/pi)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--eval_step", default=2000, type=int,
                        help="The maximum total input sequence length after WordPiece tokenization. Sequences "
                             "longer than this will be truncated, and sequences shorter than this will be padded.")
    # parser.add_argument("--eval_step", default=485, type=int,
    #                     help="The maximum total input sequence length after WordPiece tokenization. Sequences "
    #                          "longer than this will be truncated, and sequences shorter than this will be padded.")
